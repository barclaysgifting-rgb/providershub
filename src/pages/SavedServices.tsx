  ...
  const [savedServices, setSavedServices] = useState([
    {
      ...
      description: 'Complete CQC registration package including all necessary documentation and regulatory compliance support.'
    },
    {
      id: 2,
      ...
      description: 'Comprehensive healthcare compliance audit services with detailed reporting and improvement recommendations.'
    },
    {
      id: 3,
      ...
      description: 'Full care home licensing support including application preparation and regulatory compliance guidance.'
    },
    {
      id: 4,
      ...
      description: 'Professional regulatory documentation review and compliance checking services.'
    }
  ]);
